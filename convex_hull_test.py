...
def test_convex_hull_1():
    coords = [[-5.8, 7.2], [-5.5, -4.5], [-3.7, -1.3], [-3.5, 3.0],
              [-2.7, 1.4], [-2.2, 4.3], [-1.7, 2.6], [-1.6, 1.9], [1.6, 4.3],
              [5.1, 5.9]]
...
def test_convex_hull_6():
    coords = [[-8.0, 4.0], [-8.0, 5.0], [-8.0, 5.9], [-8.0, 8.0], [-6.2, 2.5],
              [-4.7, 7.7], [-4.1, 2.7], [-2.9, 5.6]]
    assert convex_hull(coords) == coords


def test_convex_hull_7():
    coords = [[-8.0, 4.0], [-8.0, 5.0], [-8.0, 5.9], [-8.0, 8.0], [-6.2, 2.5],
              [-5.0, 5.0], [-4.1, 2.7], [-2.9, 5.6]]
    assert convex_hull(coords) == [[-8.0, 4.0], [-8.0, 5.0], [-8.0, 5.9],
                                   [-8.0, 8.0], [-6.2, 2.5], [-4.1, 2.7],
                                   [-2.9, 5.6]]
...
def test_convex_hull_8():
    coords = [[-7.9, 3.1], [-7.9, 3.6], [-7.9, 4.4],
              ...
              [-5.0, 2.8], [-3.7, 4.3]]
    assert sorted(convex_hull(coords)) == [[-7.9, 3.1], [-7.9, 3.6],
                                           [-7.9, 4.4],
                                           [-6.0, 6.0], [-5.6, 6.0],
                                           [-5.2, 6.0],
                                           [-4.9, 1.0], [-4.6, 6.0],
...
def test_upper_hull_2():
    ...
    assert sorted(upper_hull(coords, 0, 3)) == [[-5.1, 5.0], [-3.9, 5.0],
                                                [-3.3, 5.0]]
...
def test_upper_hull_6():
    coords = [[-6.0, 5.0], [-5.1, 5.0], [-3.9, 5.0], [-3.3, 5.0]]
    assert sorted(upper_hull(coords, 3, 0)) == [[-6.0, 5.0], [-5.1, 5.0],
                                                [-3.9, 5.0]]
