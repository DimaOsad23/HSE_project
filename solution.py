...
class Solution:
    ...
    def main(self, coords):
        '''
        Main function of solution, checking all variants of answer and
        find quadrilateral with max space
    ...
    def false_quadrilateral(self, p_1, p_2, p_3, p_4):
        '''
        Find answer to question "Are this 4 points can make
        quadrilateral"
        ...
        :param p_4: point 4
        :type p_4: list
        :returns: answer to question "Are this 4 points can make
        quadrilateral"
        :rtype: bool
        '''

        # Проверка, лежат ли 3 точчки на одной прямой с помощью
    ...
    # Нахаждение квадрата косинуса угла между векторами
    ...
    def space_quadrilateral(self, p_1, p_2, p_3, p_4):
        ...
        type p_4: list
        :returns: None
        :note: if finds sequence of points with new max space update max
        space
