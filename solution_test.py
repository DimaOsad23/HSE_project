...
def test7():
    ...
    res = s.main(coords)
    assert round(res[1], 3) == 87.54 and sorted(res[0]) == [
        [-6, 6.8],
        [-3.3, -3.5],
        [5.4, -2.2],
        [6.4, 4.2],
...
def test_f_q_1():
    s = Solution()
    assert (
        s.false_quadrilateral([-7.0, 5.0], [-6.0, 6.0],
                              [-5.0, 7.0], [-3.5, 3.5]) == 1
    )
...
def test_f_q_2():
    s = Solution()
    assert (
        s.false_quadrilateral([-7.0, 5.0], [-6.1, 6.0],
                              [-5.0, 7.0], [-3.5, 3.5]) == 0
    )
...
def test_f_q_3():
    s = Solution()
    assert (
        s.false_quadrilateral([-7.5, 7.4], [-2.6, 7.6],
                              [-4.4, 2.4], [-4.8, 5.2]) == 0
    )
